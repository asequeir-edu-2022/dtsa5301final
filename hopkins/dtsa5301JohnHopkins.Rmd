...
Looks like this data is for places such as cruise ships and non states such as Virgin Islands.
I will ignore such data for this report.
...
The plot looks thick since each state/county gets a point per day.
```{r}
covid19_by_state %>%
